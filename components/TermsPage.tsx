...
export default function TermsPage() {
  ...
  return (
    <LegalLayout
      ...
      lead="The rules for using Prokuro’s BOM risk analysis service: what we provide, what you own, and how we work together."
      ...
      glance={
        <>
          ...
          <li>
            Questions: <a href={mailto}>{SALES_EMAIL}</a>
          </li>
        </>
      }
    >
      <section id="agreement" className="mk-legal-section">
        <LegalNum n={1} />
        <h2>Agreement</h2>
        <p>
      ...
      <section id="the-service" className="mk-legal-section">
        <LegalNum n={2} />
        <h2>The service</h2>
        <p>
      ...
      <section id="accounts" className="mk-legal-section">
        <LegalNum n={3} />
        <h2>Accounts</h2>
        <p>
        ...
        <ul>
          ...
          <li>
            Notify us promptly at <a href={mailto}>{SALES_EMAIL}</a> if you suspect unauthorized access.
          </li>
      ...
      <section id="your-content" className="mk-legal-section">
        <LegalNum n={4} />
        <h2>Your content</h2>
        <p>
        ...
        <ul>
          <li>
            <strong>You retain ownership</strong> of Your Content. These Terms do not transfer ownership to Prokuro.
          </li>
          <li>
          ...
          <li>
            ...
            <a href={mailto}>{SALES_EMAIL}</a>. See our <Link href={PRIVACY_PATH}>Privacy Policy</Link> for
            retention details.
          </li>
        </ul>
      </section>

      <section id="ai-output" className="mk-legal-section">
        <LegalNum n={5} />
        <h2>AI output</h2>
        <p>
        ...
        <ul>
          ...
          <li>We do not guarantee that output is error-free, complete, or suitable for any particular use.</li>
        </ul>
        <p>
      ...
      <section id="acceptable-use" className="mk-legal-section">
        <LegalNum n={6} />
        ...
        <ul>
          ...
          <li>
            Scrape, crawl, or systematically extract data from the Service except through documented APIs we provide.
          </li>
          ...
          <li>
            Upload malware, corrupted files intended to harm systems, or content you do not have rights to share.
          </li>
      ...
      <section id="third-party-data" className="mk-legal-section">
        <LegalNum n={7} />
      ...
      <section id="fees" className="mk-legal-section">
        <LegalNum n={8} />
        <h2>Fees</h2>
        <p>
      ...
      <section id="termination" className="mk-legal-section">
        <LegalNum n={9} />
        <h2>Termination</h2>
        <p>
      ...
      <section id="disclaimers" className="mk-legal-section">
        <LegalNum n={10} />
        <h2>Disclaimers</h2>
        <p>
      ...
      <section id="liability" className="mk-legal-section">
        <LegalNum n={11} />
      ...
      <section id="indemnification" className="mk-legal-section">
        <LegalNum n={12} />
      ...
      <section id="disputes" className="mk-legal-section">
        <LegalNum n={13} />
        <h2>Disputes</h2>
        <p>
