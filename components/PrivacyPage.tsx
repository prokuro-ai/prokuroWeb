      ...
      <article className="legal">
        ...
        <div className="container">
          ...
          <p className="legal__lead">
            How Prokuro collects, uses, and protects your account details and the bill-of-materials data you upload.
          </p>
        </div>
      ...
      <div className="container legal__layout">
        ...
        <div className="legal__body">
          ...
          <section id="what-we-collect" className="legal__section">
            ...
            <p>
              We only collect what we need to run the product. This table lists every category we handle today.
            </p>
                ...
                <tbody>
                  {COLLECTED.map((row) => (
                    <tr key={row.category}>
                      ...
                      <td>{row.examples}</td>
                      <td className="legal__table-muted">{row.source}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <section id="what-we-do-not-collect" className="legal__section">
          ...
          <section id="how-we-use-it" className="legal__section">
          ...
          <section id="legal-bases" className="legal__section">
          ...
          <section id="your-bom-data" className="legal__section">
          ...
          <section id="who-we-share-with" className="legal__section">
                ...
                <tbody>
                  {SUBPROCESSORS.map((row) => (
                    <tr key={row.provider}>
                      ...
                      <td>{row.purpose}</td>
                      <td className="legal__table-muted">{row.region}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
