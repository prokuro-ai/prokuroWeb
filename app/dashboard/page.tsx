  ...
  return (
    <AppLayout>
      <div className="flex h-14 flex-shrink-0 items-center justify-between border-b border-[#d6deea] bg-white px-6">
        ...
        <Link href="/bom/new" className="flex items-center gap-1.5 rounded-lg bg-[#0062ff] px-3.5 py-1.5 text-[13px] font-medium text-white transition-colors hover:bg-[#0050e6]">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        <div className="rounded-xl border border-[#d6deea] bg-white">
          <div className="flex items-center justify-between border-b border-[#d6deea] px-5 py-3.5">
            ...
            <span className="text-[12px] text-[#7a8598]">0 BOMs</span>
          </div>
            ...
            <tbody>
              <tr>
                <td colSpan={6} className="px-4 py-16 text-center">
                  ...
                  <Link href="/bom/new" className="mt-4 inline-flex items-center gap-1.5 rounded-lg bg-[#0062ff] px-4 py-2 text-[13px] font-medium text-white transition-colors hover:bg-[#0050e6]">
                    <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                    </svg>
